...
<head>
    ...
    <title>Digital Library | Signup</title>
            ...
            <div class="panel-body">
                <form name="signup" method="post" onSubmit="return valid();">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="vercode" maxlength="5" autocomplete="off" required style="width: 150px; height: 30px;" />
                        <div class="vercode"><img src="captcha.php"  class="captcha-image" alt="Captcha"></div>
                    </div>
